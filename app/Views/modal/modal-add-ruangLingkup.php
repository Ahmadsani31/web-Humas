<?php
$Nama  = '';
$LingkupID =  $_POST['ruanglingkupid'];
if (!empty($LingkupID)) {
    $qeu = querySelect('', 'kerma_ruang_lingkup', 'NA="N" AND LingkupID="' . $LingkupID . '"')->getRow();
    $Nama  = $qeu->Nama;
}
?>

<form action="<?= route_to('save.ruangLingkup'); ?>" method="post" id="form-acara">
    <?= csrf_field() ?>
    ...
    <input type="hidden" name="LingkupID" value="<?= $LingkupID; ?>">
