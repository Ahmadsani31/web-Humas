<?php
$Nama  = '';
$BidangID =  $_POST['bidangid'];
if (!empty($BidangID)) {
    $qeu = querySelect('', 'kerma_bidang', 'NA="N" AND BidangID="' . $BidangID . '"')->getRow();
    $Nama  = $qeu->Nama;
}
?>

<form action="<?= route_to('save.bidang'); ?>" method="post" id="form-acara">
    <?= csrf_field() ?>
    ...
    <input type="hidden" name="BidangID" value="<?= $BidangID; ?>">
