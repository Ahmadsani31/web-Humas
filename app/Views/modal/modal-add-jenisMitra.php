...
$JenisMitraID =  $_POST['jenismitraid'];
if (!empty($JenisMitraID)) {
    $qeu = querySelect('', 'mitra_jenis', 'NA="N" AND JenisMitraID="' . $JenisMitraID . '"')->getRow();
    $Nama = $qeu->Nama;
}
?>

<form action="<?= route_to('save.jenis'); ?>" method="post" id="form-acara">
    <?= csrf_field() ?>
    ...
    <input type="hidden" name="JenisMitraID" value="<?= $JenisMitraID; ?>">
